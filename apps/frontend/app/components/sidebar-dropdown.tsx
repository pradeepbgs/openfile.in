            ...
            <ul className="py-1.5 text-sm">
                <li>
                    <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-black font-bold hover:bg-[#FFF8E7] flex items-center gap-2.5 transition-colors"
                    >
                        <FiStar className="text-[#FFD400]" size={15} />
                        Upgrade to Pro
                    </button>
                </li>
