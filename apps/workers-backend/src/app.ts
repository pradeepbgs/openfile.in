...
import { diesel_auth_router, diesel_file_router, fileRouter, linkRouter } from './routes'
...
app
    ...
    .mount('/api/v1/auth', diesel_auth_router.fetch() as any)
    .route("/api/v1/link", linkRouter)
    .mount('/api/v1/file/upload-url', diesel_file_router.fetch() as any)
